declare module "novacord-dashboard" {
    /** The Dashboard to handler our express app and its configurations
     * @link https://novaai.engineerpatterson.com/docs
     */
  class Dashboard {
...
interface config_options {
    ...
    invite: {
        ...
        redirectUri: "https://discord.com/oauth2/authorized";
         ...
         */
        permissions: 19527400942711;
        /** Your bot Id */
        clientId: "1172432649307037787";
 ...
 *
 * @link https://novaai.engineerpatterson.com/docs?id=documentation
 *
 */
        ...
        categoryOptionsList: [
            {
                 ...
                 * @link https://novaai.engineerpatterson.com/docs?id=option-types
                 *
                 ...
                 * @link https://novaai.engineerpatterson.com/docs?id=options
                 *
                 * @example
                 * getActualSet: ({ guild }) => {};
                 */
