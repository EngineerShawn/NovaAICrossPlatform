...
module.exports = {
    ...
    execute: async (req, res, app, config, themeConfig, info) => {
        ...
        let onlineFiles = {
            index: await fetch(
                `https://cdn.jsdelivr.net/gh/Assistants-Center/Novacord-UI/views/index.ejs`
            ),
            guild: await fetch(
                `https://cdn.jsdelivr.net/gh/Assistants-Center/Novacord-UI/views/guild.ejs`
            ),
            guilds: await fetch(
                `https://cdn.jsdelivr.net/gh/Assistants-Center/Novacord-UI/views/guilds.ejs`
            )
        }
        ...
        let onlineV = await fetch(
            `https://cdn.jsdelivr.net/gh/Assistants-Center/Novacord-UI/utils/updater/versionsOnline.json`
        )
        ...
        res.render('debug', {
            ...
            themeVersion: require(`novacord-ui`).version,
