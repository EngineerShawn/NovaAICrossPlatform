...
const NBDStats = require('./ExternalStatistics/index');
...
class Dashboard {
    ...
    async init() {
        require('./InitFunctions/initPpCheck')(this.config, this.config.theme.themeConfig, NBDStats, this.secretInit, this.modules, this);
    }
